// Geometry for a complete solid OBB: designated-face contact sampling, and the
// fixed-world grid rasterization that turns one pose into the compressed support
// placement layout. Migrated from TreePhysics src/physics/obb/internal/Geometry.ts.
import type { Vector3 } from "@minecraft/server";
import type { CollisionRegion } from "./Activation.js";
import { SLOPE_RISE_SIN } from "../ObbTypes.js";
import type {
  ObbSurfaceContact,
  ObbSettings,
  ObbSize,
...
import { add, dot, scale, subtract } from "../../../../util/SableVector3Utils.js";
import {
...
} from "./GeometryKeys.js";
import { getPoseObbVerticalInterval, type VolumeColumnInterval } from "./Interval.js";
import {
