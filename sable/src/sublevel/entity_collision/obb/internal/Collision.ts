// The persistent native support surface: spawns, reuses, moves, and removes the
// collision proxy entities that realize one OBB's placement layout, atomically
// per sync. Migrated from TreePhysics src/physics/obb/internal/Collision.ts.
import type { Dimension, Entity, Vector3 } from "@minecraft/server";
import type { CollisionRegion } from "./Activation.js";
import { ObbGeometry, type SupportGridOrigin } from "./Geometry.js";
import type {
  ObbCollisionShell,
  ObbCollisionUpdate,
  ObbTransform,
...
import { EPSILON_1E6 } from "../../../../util/SableVector3Utils.js";
