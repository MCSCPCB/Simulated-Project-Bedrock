// Contact-plane motion for actors standing on an OBB: rigid-surface motion
// inheritance and the bounded tangential friction impulse that removes relative
// slip. Migrated from TreePhysics src/physics/obb/internal/Motion.ts.
import type { Entity, Vector3 } from "@minecraft/server";
import type { ObbFrictionSettings } from "../ObbTypes.js";
import { EPSILON_1E6, add, dot, length, scale, subtract } from "../../../../util/SableVector3Utils.js";
