// Actor-driven collision-region activation: one compact swept neighborhood per
// nearby actor, with optional short retention while a replacement region takes
// over. Migrated from TreePhysics src/physics/obb/internal/Activation.ts.
 ...
 * swept AABB exits that interior, one replacement region is computed. An
