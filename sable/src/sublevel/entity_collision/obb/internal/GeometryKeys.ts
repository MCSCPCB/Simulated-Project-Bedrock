// The placement-map key grammar shared by the OBB geometry builders and the
// support surface's layout diff. Migrated from TreePhysics
// src/physics/obb/internal/GeometryKeys.ts.
