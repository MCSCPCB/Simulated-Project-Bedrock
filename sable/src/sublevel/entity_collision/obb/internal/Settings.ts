// Validation and caching of caller-supplied OBB settings and support-preset
// catalogs, so every resolved value is frozen and self-consistent before the
// geometry uses it. Migrated from TreePhysics src/physics/obb/internal/Settings.ts.
import { EPSILON_1E6 } from "../../../../util/SableVector3Utils.js";
import { assertFrictionSettings } from "./Motion.js";
import {
