...
// origin-anchored quantization, and region/cell coverage tests. Migrated from
// TreePhysics src/physics/obb/internal/PlacementGrid.ts.
import type { Vector3 } from "@minecraft/server";
import type { CollisionRegion } from "./Activation.js";
import type { ObbSize, ObbTransform } from "../ObbTypes.js";
import { dot, subtract } from "../../../../util/SableVector3Utils.js";
import {
  GEOMETRY_EPSILON,
