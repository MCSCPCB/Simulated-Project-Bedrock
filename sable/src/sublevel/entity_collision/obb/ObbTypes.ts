// Shared types for the oriented-box entity collision layer: world pose and
// size, the collision settings every supported OBB obeys, the support-proxy
// preset catalog, and the update/contact result shapes. Migrated from
// TreePhysics src/physics/obb/Types.ts.
