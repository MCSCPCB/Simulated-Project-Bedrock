// A moving, entity-collidable oriented box: owns its pose, the persistent
// native support proxies that give it collision, and the bounded tangential
// friction that carries grounded actors. Migrated from TreePhysics
// src/physics/obb/Solid.ts.
...
} from "./internal/Activation.js";
import { SupportSurface } from "./internal/Collision.js";
import { ObbGeometry } from "./internal/Geometry.js";
import { applyTangentialFriction } from "./internal/Motion.js";
import { EPSILON_1E6, add, length, subtract } from "../../../util/SableVector3Utils.js";
import {
...
import { resolveSettings, resolveSupportPresets } from "./internal/Settings.js";
