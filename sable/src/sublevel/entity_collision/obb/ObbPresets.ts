// The default support-proxy preset catalog: every collision-box variant a
// standard OBB support entity implements, derived from the shared OBB settings.
// Migrated from TreePhysics src/physics/obb/data/Presets.ts.
import { DEFAULT_OBB_SETTINGS } from "./ObbTypes.js";
import type { ObbSupportPreset, ObbSupportPresetCatalog } from "./ObbTypes.js";
