// The math behind dragging a sub-level with the crosshair: the spring/damper
// force and angular damping torque (plain and semi-implicit stable forms), the
// grab distance clamp, the item-use action resolution and the rest test.
// Migrated from TreePhysics src/content/player/Drag.ts.
...
export function getEffectiveMassByWorldAxis(body: RigidBodyHandle, location: Vector3): Vector3 {
  return {
...
export function getEffectiveInertiaByWorldAxis(body: RigidBodyHandle): Vector3 {
  return {
