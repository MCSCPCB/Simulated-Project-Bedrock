// Turns vanilla explosions into queued sub-level forces: the impacted blocks
// feed cache invalidation, and the blast center plus radius are queued on the
// force queue. Migrated from TreePhysics src/events/contraption/Explosion.ts.
...
export function installSubLevelExplosionPhysics(
