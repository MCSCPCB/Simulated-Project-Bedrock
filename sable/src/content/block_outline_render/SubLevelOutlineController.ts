...
export class SubLevelOutlineController {
  ...
  handleBreak(
    ...
    // Every projected block mines; unregistered blocks use the default hardness.
  ...
  #updateViewerShape(
    ...
    // Resolve the support behind a multi-face attachment before caching the
    // preview; the support can change while the selected cell stays the same.
    ...
    const blockPlacement = item && placementResult ? this.#getPlacementTarget(placementResult, item) : undefined;
