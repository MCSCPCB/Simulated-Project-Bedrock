// Continuous YZX Euler extraction from quaternions and the matching vector
// rotation, shared by the physics pipeline, render rotation, and entity
// collision frames. Migrated from TreePhysics src/physics/motion/RotationContinuity.ts.
