...
// SubLevelBlockRecord): permutation state/tag probes, neighbor lookup, type
// name helpers, and the custom-block passability ray cache. Migrated from
// TreePhysics src/physics/collision/BlockState.ts.
import type { Block, Dimension } from "@minecraft/server";
import { safeGetBlock } from "../../../../util/LevelAccelerator.js";

interface SubLevelBlockRecord {
...
type BlockCollisionShapeSource = Block | SubLevelBlockRecord;
