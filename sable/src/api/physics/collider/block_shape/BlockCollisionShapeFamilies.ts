...
// dispatched from BlockCollisionShapeResolver.ts. Migrated from TreePhysics
// src/physics/collision/ShapeFamilies.ts.
import type {
  BlockCollisionBoxShapeDefinition,
  BlockCollisionShape
} from "./BlockCollisionShapeResolver.js";
import {
  getBlockNamespace,
  getBlockTypeName,
  getFirstNumberState,
...
import { resolveSableDynamicBoxes } from "./BlockCollisionShapeTables.js";
