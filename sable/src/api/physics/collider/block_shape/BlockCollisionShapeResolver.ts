...
// dispatch entry, the resolution-plan metadata consumed by the Cannon physics
// pipeline, and the shared shape types. Implementations live in the sibling
// shape and block-state modules. Migrated from TreePhysics
// src/physics/collision/BlockShapeResolver.ts.
import {
  SABLE_COLLISION_BLOCK_RECORDS,
  SABLE_STATIC_COLLISION_RECORDS,
  VANILLA_COLLISION_RECORDS
} from "../../../../data/vanilla/collision/BlockCollisionRecords.js";
import {
  getBlockNamespace,
  getBlockTypeName,
  isEmptyLiveBlock,
...
} from "./BlockCollisionShapeState.js";
import {
  AZALEA_BOXES,
  BELL_BOXES,
  BREWING_STAND_BOXES,
  ...
  resolveWallBoxes
} from "./BlockCollisionShapeFamilies.js";
import {
  FULL_SHAPE,
  NONE_SHAPE,
  box,
  ...
  modelBox,
  partialShape
} from "./BlockCollisionShapeGeometry.js";
import {
  resolveGeneratedVanillaShape,
  resolveSableStaticShape
} from "./BlockCollisionShapeTables.js";
