// Greedy voxel-to-box meshing over a dense grid, keyed by material and
// collision response. Migrated from TreePhysics src/physics/core/GreedyBoxMesher.ts.
 ...
 * from SubLevelVoxelMesher.meshVoxels, whose deterministic search minimizes box count.
 */
