// Separating-axis contact normal between an oriented box and an axis-aligned
// box, used by the world-sensor sweep. Migrated from TreePhysics
// src/physics/collision/OrientedBoxAabbSat.ts.
