// World solid-block scanning for the cannon physics pipeline: scan-bounds
// clusters, row coverage, shadow filtering, batch block reads, and the
// greedy-meshed solid and fluid scans shared by the cached and uncached collider
// sync paths. Migrated from TreePhysics src/physics/world/BlockScan.ts.
