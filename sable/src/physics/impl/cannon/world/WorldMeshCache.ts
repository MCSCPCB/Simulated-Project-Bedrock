// Chunked world-mesh cache primitives for the cannon physics pipeline: chunk
// keys and requests, cached-chunk scanning/signatures, and the per-chunk
// sensor-box bin index. The runtime cache bookkeeping itself remains in the
// pipeline. Migrated from TreePhysics src/physics/world/MeshCache.ts.
import type { Block, Dimension, Vector3 } from "@minecraft/server";
import type { Body } from "../cannon-es.js";
import type { PhysicsBlockProperties } from "../../../../api/physics/PhysicsTypes.js";
import { GreedyBoxMesher, type GreedyBox } from "../../../../api/physics/collider/GreedyBoxMesher.js";
import {
  compareStrings,
