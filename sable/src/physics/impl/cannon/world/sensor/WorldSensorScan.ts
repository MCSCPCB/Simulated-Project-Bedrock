// Indexed world-sensor sweep for the cannon physics pipeline: swept
// oriented-box samples and SAT contact selection against cached sensor boxes.
// Chunk-key enumeration stays in WorldSensorChunkIndex.ts; the two are
// deliberately separate. Migrated from TreePhysics
// src/physics/world/sensor/Scan.ts.
import type { Vector3 } from "@minecraft/server";
import type { Quaternion, Vec3 } from "../../cannon-es.js";
...
} from "../../../../../api/physics/collider/OrientedBoxAabbSat.js";
import {
  lerp,
  multiplyQuaternions,
...
import { clamp } from "../../../../../util/SableVector3Utils.js";
