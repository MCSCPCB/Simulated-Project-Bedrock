// Chunk-key enumeration for the indexed world-sensor sweep: maps one sweep's
// integer bounds onto the retained world-mesh chunk keys. Migrated from
// TreePhysics src/physics/world/sensor/ChunkIndex.ts.
...
/** Read-only membership view over the pipeline's retained world-mesh chunk keys. */
