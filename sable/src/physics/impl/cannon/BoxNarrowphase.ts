// Box-only narrowphase for the cannon physics pipeline: per-body box transform
// caching, an AABB pre-rejection pass, and box/box separating-axis contacts that
// keep Cannon's axis order, clipping, materials and equation pooling. Migrated
// from TreePhysics src/physics/simulation/BoxNarrowphase.ts.
import {
