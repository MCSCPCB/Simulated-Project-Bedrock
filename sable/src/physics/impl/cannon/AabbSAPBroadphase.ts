// Sweep-and-prune broadphase that terminates each sweep on the sorted axis
// bounds instead of scanning the whole axis list. Migrated from TreePhysics
// src/physics/simulation/AabbSAPBroadphase.ts.
import { SAPBroadphase, type Body, type World } from "./cannon-es.js";
