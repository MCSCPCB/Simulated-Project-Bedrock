...
// the cannon physics pipeline and its world-scan modules. Keep these pure so
// every caller observes identical floating-point results. Migrated from
// TreePhysics src/physics/motion/KernelMath.ts.
import type { Vector3 } from "@minecraft/server";
import { Quaternion, Vec3 } from "./cannon-es.js";
import type { Body } from "./cannon-es.js";
import type { OrientedBoxRotationMatrix } from "../../../api/physics/collider/OrientedBoxAabbSat.js";
