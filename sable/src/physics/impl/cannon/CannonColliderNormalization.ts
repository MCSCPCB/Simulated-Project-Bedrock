// Collider normalization and convex-polyhedron validation for the cannon
// physics pipeline: converts user collider definitions into the normalized shape
// records and cannon-es shapes the runtime consumes. Migrated from TreePhysics
// src/physics/core/ColliderNormalization.ts.
...
import { toCannonQuaternion } from "./CannonMath.js";
