...
function isSerializedSubLevelBlock(value) {
  ...
  return hasOnlyKeys(block, [
    ...
    "visualYOffset",
    "visualOffset"
  ]) && typeof block.typeId === "string" && block.typeId.length > 0 && isIntegerLocation(block.localLocation) && (block.itemTypeId === void 0 || typeof block.itemTypeId === "string") && (block.collidable === void 0 || typeof block.collidable === "boolean") && (block.collisionResponse === void 0 || typeof block.collisionResponse === "boolean") && (block.runtimeCollidable === void 0 || typeof block.runtimeCollidable === "boolean") && (block.visualYOffset === void 0 || isFiniteNumber(block.visualYOffset)) && (block.visualOffset === void 0 || isVector(block.visualOffset)) && isCollisionShape(block.collisionShape) && (block.rotation === void 0 || isVector(block.rotation)) && (block.states === void 0 || isBlockStates(block.states)) && (block.mapColor === void 0 || isBlockMapColor(block.mapColor));
}
